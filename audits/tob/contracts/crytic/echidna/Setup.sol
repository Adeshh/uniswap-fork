...
import '../../../../../contracts/DefiedgeV3Factory.sol';
...
contract SetupTokens {
    ...
    constructor() public {
        ...
        // since this is what the Defiedge factory will do when you create the pool
...
contract SetupDefiedge {
    DefiedgeV3Pool public pool;
    TestERC20 token0;
    TestERC20 token1;
    ...
    DefiedgeV3Factory factory;

    constructor(TestERC20 _token0, TestERC20 _token1) public {
        factory = new DefiedgeV3Factory();
        token0 = _token0;
        token1 = _token1;
    }

    function createPool(uint24 _fee, uint160 _startPrice) public {
        pool = DefiedgeV3Pool(factory.createPool(address(token0), address(token1), _fee));
        pool.initialize(_startPrice);
    }
}

contract DefiedgeMinter {
    DefiedgeV3Pool pool;
    TestERC20 token0;
    TestERC20 token1;
    ...
    function setPool(DefiedgeV3Pool _pool) public {
        pool = _pool;
    }
