...
describe('DefiedgeV3Pool', () => {
  ...
  let pool0: MockTimeDefiedgeV3Pool
  let pool1: MockTimeDefiedgeV3Pool
  ...
  let swapTargetCallee: TestDefiedgeV3Callee
  let swapTargetRouter: TestDefiedgeV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeDefiedgeV3Pool, any]> => {
