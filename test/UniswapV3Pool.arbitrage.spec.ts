...
import { DefiedgeV3PoolSwapTest } from '../typechain/DefiedgeV3PoolSwapTest'
...
describe('DefiedgeV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('DefiedgeV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as DefiedgeV3PoolSwapTest
          ...
          let tester: DefiedgeV3PoolSwapTest
