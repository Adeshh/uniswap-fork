...
export function createPoolFunctions({
  ...
  swapTarget: TestDefiedgeV3Callee
  token0: TestERC20
  token1: TestERC20
  pool: MockTimeDefiedgeV3Pool
}): PoolFunctions {
...
export function createMultiPoolFunctions({
  ...
  swapTarget: TestDefiedgeV3Router
  poolInput: MockTimeDefiedgeV3Pool
  poolOutput: MockTimeDefiedgeV3Pool
}): MultiPoolFunctions {
